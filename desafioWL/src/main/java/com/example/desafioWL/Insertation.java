...
public class Insertation implements CommandLineRunner {
	...
	public void run(String... arg) throws Exception {
		...
		User u1 = new User(null, "Tales", "45612378958", i1);
		User u2 = new User(null, "Isabelly", "78945612352", i2);
		User u3 = new User(null, "Julio", "82241598736", i3);
		User u4 = new User(null, "Paulinha", "89765438545", i4);
		User u5 = new User(null, "Roberto", "14796325865", i5);
